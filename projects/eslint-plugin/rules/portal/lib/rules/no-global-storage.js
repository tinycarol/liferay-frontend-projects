...
const DESCRIPTION =
	'Direct usage of the `localStorage` and `sessionStorage` API is discouraged in favour of our wrapped version that checks user consent status; import `localStorage` or `sessionStorage` from frontend-js-web instead';
